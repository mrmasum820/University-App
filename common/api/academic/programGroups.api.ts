...
export const ProgramGroupsQueryKey = {
  ALL_List: "programGroupsALLList",
  List: "programGroupsList",
  Create: "programGroupsCreate",
  Edit: "programGroupsEdit",
  Update: "programGroupsUpdate",
  Delete: "programGroupsDelete",
};
// api endpoint
...
//  api config
export const programGroupsAllList = async <R>(
  params: paramsProps
): Promise<R> => {
...
export const programGroupsList = async () => {
  const res = await apiConfig.get(ApiEndPoint.LIST_API);
  return res.data;
};

export const programGroupsCreate = async <T, R>(data: T): Promise<R> => {
  const res = await apiConfig.post<R>(ApiEndPoint.CREATE_API, data);
  return res.data;
};

export const programGroupsEdit = async (id: number) => {
  const res = await apiConfig.get(ApiEndPoint.Edit_API(id));
  return res.data;
};

export const programGroupsUpdate = async <T, R>(
  id: number,
  data: T
): Promise<R> => {
...
export const programGroupsTrash = async <T>(data: T): Promise<T> => {
