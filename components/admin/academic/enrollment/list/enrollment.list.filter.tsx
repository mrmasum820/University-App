...
export default function EnrollmentListFilter({
  table,
}: TableFilterProps<EnrollmentEntity>) {
  ...
  const mutation = useMutation<TrashEntity, Error, TrashEntity>({
    mutationKey: [EnrollmentQueryKey.Delete],
    mutationFn: (value) => enrollmentTrash(value),
    onSettled: () => {
