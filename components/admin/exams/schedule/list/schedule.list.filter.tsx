...
export default function ScheduleListFilter({
  table,
}: TableFilterProps<ExamScheduleEntity>) {
  ...
  const mutation = useMutation<TrashEntity, Error, TrashEntity>({
    mutationKey: [ExamScheduleQueryKey.Delete],
    mutationFn: (value) => examScheduleTrash(value),
    onSettled: () => {
