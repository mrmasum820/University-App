...
import { SuppliersQueryKey, suppliersTrash } from "@/common/api";
...
export default function SupplierListFilter({
  table,
  tableData,
}: TableFilterProps<SupplierEntity>) {
  ...
  const mutation = useMutation<TrashEntity, Error, TrashEntity>({
    mutationKey: [SuppliersQueryKey.Delete],
    mutationFn: (value) => suppliersTrash(value),
    onSettled: () => {
